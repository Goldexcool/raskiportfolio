  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute  w-40 h-[100%] right-0 bg-[#1c0544] bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-[#1c0544] "></div>
      </div>
